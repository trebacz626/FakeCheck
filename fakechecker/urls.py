...
urlpatterns = (
    ...
    path("fakechecker/Redactor/detail/<int:pk>/", views.RedactorDetailView.as_view(), name="fakechecker_Redactor_detail"),
    ...
    path("fakechecker/Review/create/", views.ReviewCreateView.as_view(), name="fakechecker_Review_create"),
    ...
    path("fakechecker/Question/create/", views.QuestionCreateView.as_view(), name="fakechecker_Question_create"),
